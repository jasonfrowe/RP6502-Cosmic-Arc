...
#define STAR_MAP_DATA_SIZE      0x0120U // Size of Star Map tile data (6 tiles * 16x16 / 2 bytes = 768 bytes)

#define STAR_MAP_TILEMAP_DATA   (STAR_MAP_DATA + STAR_MAP_DATA_SIZE) // Address for Star Map tilemap data
#define STAR_MAP_TILEMAP_SIZE   0x04B0U // Size of Star Map tilemap data (300 bytes)

#define LASER_DATA              (STAR_MAP_TILEMAP_DATA + STAR_MAP_TILEMAP_SIZE) // Address for laser sprite data
...
#define STAR_MAP_WIDTH_TILES 40
#define STAR_MAP_HEIGHT_TILES 30
