...
#define MAIN_MAP_DATA_SIZE      0x3EC0 // 16064 bytes (251 tiles * 8x8 * 8bpp)
...
#define LANDER_DATA_SIZE        0x0E00U // Size of lander sprite data (4 parts * 16x16 * 2 bytes = 4096 bytes)
